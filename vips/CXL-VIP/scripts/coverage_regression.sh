#!/bin/bash
#=============================================================================#
# Coverage-Driven Regression — CXL-VIP
...
TESTS=${TESTS:-"mp_error_inject_test mp_random_regression_test mp_cxl20_test mp_cxl30_test mp_power_mgmt_test mp_base_test"}

echo "=============================================================="
echo " CXL-VIP — Coverage-Driven Regression"
