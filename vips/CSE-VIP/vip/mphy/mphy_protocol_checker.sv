...
//
//============================================================================
//  MPHY Protocol Checker (stub)
//  Minimal activity/validity checker for the MPHY lane of mipi_vip_if.
...
class mphy_protocol_checker extends uvm_component;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(virtual mipi_vip_if)::get(this, "", "vif", vif))
      `uvm_fatal("CONFIG", "MPHY chk: no vif")
  endfunction
  ...
  task run_phase(uvm_phase phase);
    forever begin
      ...
      if (vif.mphy_hs_mode || vif.mphy_ls_mode) active_cycles++;
      if (vif.mphy_hs_mode && vif.mphy_gear > 4'd5) err_cnt++;
    end
  endtask

  virtual function void report_phase(uvm_phase phase);
    super.report_phase(phase);
    `uvm_info("MPHY_RPT", $sformatf("MPHY chk | active:%0d err:%0d",
              active_cycles, err_cnt), UVM_LOW)
  endfunction
endclass

`endif // MPHY_PROTOCOL_CHECKER_SV
