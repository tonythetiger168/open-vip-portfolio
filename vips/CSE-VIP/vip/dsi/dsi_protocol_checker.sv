...
//
//============================================================================
//  DSI Protocol Checker (stub)
//  Minimal activity/validity checker for the DSI lane of mipi_vip_if.
...
class dsi_protocol_checker extends uvm_component;
  ...
  task run_phase(uvm_phase phase);
    forever begin
      ...
      if (vif.valid) active_cycles++;
      if (vif.ecc != 16'h0 && !vif.valid) err_cnt++;
    end
  endtask

  virtual function void report_phase(uvm_phase phase);
    super.report_phase(phase);
    `uvm_info("DSI_RPT", $sformatf("DSI chk | active:%0d err:%0d",
              active_cycles, err_cnt), UVM_LOW)
  endfunction
endclass

`endif // DSI_PROTOCOL_CHECKER_SV
