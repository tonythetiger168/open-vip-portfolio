#!/bin/bash
#=============================================================================#
# Coverage-Driven Regression — CSI_2-VIP
...
TESTS=${TESTS:-"mipi_base_test mipi_csi2_test mipi_dsi_test mipi_dphy_test mipi_cphy_test mipi_mphy_test mipi_unipro_test mipi_digrf_test mipi_hsi_test mipi_cse_test"}

echo "=============================================================="
echo " CSI_2-VIP — Coverage-Driven Regression"
