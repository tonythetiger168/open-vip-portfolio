...
//
// mipi_tests.sv -- MIPI Tests (C-PHY)
//============================================================================
...
// Directed-sequence smoke test (C-PHY normal traffic)
class mipi_cphy_test extends mipi_base_test;
  `uvm_component_utils(mipi_cphy_test)
  function new(string name = "mipi_cphy_test", uvm_component parent = null);
    super.new(name, parent);
  endfunction
  virtual task run_phase(uvm_phase phase);
...
class mipi_cphy_error_test extends mipi_base_test;
  `uvm_component_utils(mipi_cphy_error_test)
  function new(string name = "mipi_cphy_error_test", uvm_component parent = null);
    super.new(name, parent);
  endfunction
  virtual task run_phase(uvm_phase phase);
...
class mipi_cphy_reset_test extends mipi_base_test;
  `uvm_component_utils(mipi_cphy_reset_test)
  function new(string name = "mipi_cphy_reset_test", uvm_component parent = null);
    super.new(name, parent);
  endfunction
  virtual task run_phase(uvm_phase phase);
...
// Stress test
class mipi_cphy_stress_test extends mipi_base_test;
  `uvm_component_utils(mipi_cphy_stress_test)
  function new(string name = "mipi_cphy_stress_test", uvm_component parent = null);
    super.new(name, parent);
  endfunction
  virtual task run_phase(uvm_phase phase);
...
class mipi_cphy_regression_test extends mipi_base_test;
  `uvm_component_utils(mipi_cphy_regression_test)
  function new(string name = "mipi_cphy_regression_test", uvm_component parent = null);
    super.new(name, parent);
  endfunction
  virtual task run_phase(uvm_phase phase);
...
endclass
// (mipi_cphy_test legacy duplicate shell omitted -- duplicate class definitions are illegal)
