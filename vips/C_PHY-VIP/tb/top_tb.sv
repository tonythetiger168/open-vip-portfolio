...
//
// top_tb.sv -- MIPI Top-Level Testbench (C-PHY)
// Closed loop: VIP driver -> mipi_vip_if -> functional C-PHY DUT model
//============================================================================
...
module top_tb;
  ...
  c_phy_compliance_checker u_sva_chk (.vif(vif));
...
//--------------------------------------------------------------------------
// Functional C-PHY DUT model (protocol sink / PHY loopback endpoint):
