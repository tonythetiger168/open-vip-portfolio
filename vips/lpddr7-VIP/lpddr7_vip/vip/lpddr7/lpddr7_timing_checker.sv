...
// LPDDR7 Timing Performance Checker (L2)
// UVM component handle (env hookup) + companion SVA module lpddr7_timing_sva
// (concurrent assertions live in the module; LRM does not allow
//  property declarations inside classes).
`ifndef LPDDR7_TIMING_CHECKER_SV
`define LPDDR7_TIMING_CHECKER_SV
class lpddr7_timing_checker extends uvm_component;
  `uvm_component_utils(lpddr7_timing_checker)
  virtual lpddr7_if vif;
  function new(string name="lpddr7_timing_checker", uvm_component parent=null); super.new(name, parent); endfunction
...
module lpddr7_timing_sva(lpddr7_if vif);
