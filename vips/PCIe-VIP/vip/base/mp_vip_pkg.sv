...
package mp_vip_pkg;
  ...
  `include "mp_agent.sv"
  `include "pcie_protocol_checker.sv"

  //==========================================================================
  // Minimal protocol checker stubs for protocols whose dedicated checker
  // class is not part of this tree. They reuse the PCIe checker's generic
  // mp_vip_if rule checks so the multi-protocol env API is preserved.
  //==========================================================================
  class cxl_protocol_checker extends pcie_protocol_checker;
  ...
  class ucie_protocol_checker extends pcie_protocol_checker;
  ...
  class ualink_protocol_checker extends pcie_protocol_checker;
  ...
  `include "mp_pcie_gen5_test.sv"
  `include "mp_pcie_gen6_test.sv"
