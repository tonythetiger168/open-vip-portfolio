#!/bin/bash
#=============================================================================#
# Coverage-Driven Regression — PCIe-VIP
...
TESTS=${TESTS:-"mp_error_inject_test mp_pcie_gen6_test mp_random_regression_test mp_power_mgmt_test mp_base_test mp_pcie_gen5_test"}

echo "=============================================================="
echo " PCIe-VIP — Coverage-Driven Regression"
