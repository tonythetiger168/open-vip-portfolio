...
//
//============================================================================
// AMBA Environment (APB4 deepened: agent + end-to-end scoreboard + coverage)
//============================================================================
`ifndef AMBA_ENV_SV
`define AMBA_ENV_SV
...
class amba_env extends uvm_env;
  ...
  apb_compliance_checker sva_chk;
  apb_agent              agt;
  apb_coverage           fcov;
  ...
  function void build_phase(uvm_phase phase);
    ...
    sva_chk = apb_compliance_checker::type_id::create("sva_chk", this);
    agt     = apb_agent::type_id::create("agt", this);
    fcov    = apb_coverage::type_id::create("fcov", this);
  endfunction
